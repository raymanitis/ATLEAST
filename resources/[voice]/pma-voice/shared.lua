...
if GetConvar('voice_useNativeAudio', 'false') == 'true' then
	...
	Cfg.voiceModes = {
		{1.5, "Čukstēt"}, -- Whisper speech distance in gta distance units
		{3.0, "Runāt"}, -- Normal speech distance in gta distance units
		{6.0, "Kliegt"} -- Shout speech distance in gta distance units
	}
else
	Cfg.voiceModes = {
		{3.0, "Čukstēt"}, -- Whisper speech distance in gta distance units
		{7.0, "Runāt"}, -- Normal speech distance in gta distance units
		{15.0, "Kliegt"} -- Shout speech distance in gta distance units
	}
end
