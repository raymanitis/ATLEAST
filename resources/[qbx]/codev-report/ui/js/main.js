$(function(){
    ...
    $("#sendBtn").click(function(){
        ...
        setTimeout(() => {
            ...
            $(".header .subtitle").text("Izvēlies reporta iemeslu.")
            $("#sendBtn").hide()
            $("#categoryBtn").show()
    ...
    function openReportMenu(){
        ...
        $(".header .title").text("Sveicināts, " + user)
        $(".header .subtitle").text("Izvēlies iemeslu reportam.")
    ...
    function openAdminMenu(){
        ...
        $(".header .subtitle").text("Šeit ir visi jaunākie reporti ! Palīdzi cilvēkiem ja nē pizdi no rayman")
