...
Config.Blips = {
    ...
    ['air'] = {
        Garage = {
            Name = 'Lidaparatu garaza',
            Sprite = 357,
            Size = 0.5,
            Color = 17
        },
        Impound = {
            Name = 'Lidaparatu konfiskatuve',
            Sprite = 68,
            Size = 0.5,
            Color = 3
        },
...
Config.Impounds = {
    ...
    },
    {
        ...
        PedPosition = vector4(445.3663, -991.5739, 25.0725, 269.9820),
        Model = `s_m_m_armoured_01`,
    ...
    },
    {
        Visible = true,
        Type = 'car',
        Position = vector3(1737.6327, 3709.8340, 34.1372),
        PedPosition = vector4(1737.6327, 3709.8340, 34.1372, 20.9824),
        Model = `s_m_m_armoured_01`,
        SpawnPosition = vector4(1729.0312, 3713.2083, 34.1900, 22.8316)
    },
    {
        Visible = true,
        Type = 'car',
        Position = vector3(-195.5521, 6292.2515, 31.4983),
        PedPosition = vector4(-195.5521, 6292.2515, 31.4983, 315.9068),
        Model = `s_m_m_armoured_01`,
        SpawnPosition = vector4(-190.8009, 6297.5493, 31.4878, 48.0084)
    },
}
