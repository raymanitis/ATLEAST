...
exports("GetGroupLeader", function(groupId) return getGroupLeader(groupId) end)
ExportHandler('yseries', "GetGroupLeader", function(groupId) return getGroupLeader(groupId) end)

exports("IsGroupLeader", function(groupId, playerSource) isGroupLeader(groupId, playerSource) end)
ExportHandler('yseries', "IsGroupLeader", function(groupId, playerSource) isGroupLeader(groupId, playerSource) end)

exports('GetGroupMembers', function(groupId) return getGroupMembers(groupId) end)
ExportHandler('yseries', 'GetGroupMembers', function(groupId) return getGroupMembers(groupId) end)

exports("FindGroupByMember", function(playerSource) return findGroupByMember(playerSource) end)
ExportHandler('yseries', "FindGroupByMember", function(playerSource) return findGroupByMember(playerSource) end)

exports('GetJobStatus', function(groupId) return getJobStatus(groupId) end)
ExportHandler('yseries', 'GetJobStatus', function(groupId) return getJobStatus(groupId) end)

exports('SetJobStatus', function(groupId, status) setJobStatus(groupId, status) end)
ExportHandler('yseries', 'SetJobStatus', function(groupId, status) setJobStatus(groupId, status) end)

exports('GetGroupMembersCount', function(groupId) return getGroupMembersCount(groupId) end)
ExportHandler('yseries', 'GetGroupMembersCount', function(groupId) return getGroupMembersCount(groupId) end)

exports('CreateBlipForGroup', function(groupId, name, data) createBlipForGroup(groupId, name, data) end)
ExportHandler('yseries', 'CreateBlipForGroup', function(groupId, name, data) createBlipForGroup(groupId, name, data) end)

exports('RemoveBlipForGroup', function(groupId, name) removeBlipForGroup(groupId, name) end)
ExportHandler('yseries', 'RemoveBlipForGroup', function(groupId, name) removeBlipForGroup(groupId, name) end)

exports("SendGroupEvent", function(groupId, event, args) sendGroupEvent(groupId, event, args) end)
ExportHandler('yseries', "SendGroupEvent", function(groupId, event, args) sendGroupEvent(groupId, event, args) end)

exports("SetGroupData", function(groupId, key, data) setGroupData(groupId, key, data) end)
ExportHandler('yseries', "SetGroupData", function(groupId, key, data) setGroupData(groupId, key, data) end)

exports("GetGroupData", function(groupId, key) return getGroupData(groupId, key) end)
ExportHandler('yseries', "GetGroupData", function(groupId, key) return getGroupData(groupId, key) end)

exports("DestroyGroupData", function(groupId, key) destroyGroupData(groupId, key) end)
ExportHandler('yseries', "DestroyGroupData", function(groupId, key) destroyGroupData(groupId, key) end)

exports('NotifyGroup', function(groupId, message, timeout) notifyGroup(groupId, message, timeout) end)
ExportHandler('yseries', 'NotifyGroup', function(groupId, message, timeout) notifyGroup(groupId, message, timeout) end)
