job = {
    { 
        [1] = {jobs = "Lumberjack", img = "./img/lumberjack.png",img2 =  "./img/lumberjack2.png", info = "Palīdzība ir nepieciešama koku griešanā, vienkārši nocirtiet dažus kokus, un mēs jums par to samaksāsim."},
    ...
    { 
        [1] = {jobs = "Farmer",img =  "./img/farmer.png",img2 =  "./img/farmer2.png",info = "Cilvēki ir nepieciešami, lai strādātu pilsētas laukos. Lielākā daļa cilvēku dodas uz birojiem. Ko mēs ēdīsim, ja neviens nestrādās laukos?" },
    ...
    { 
        [1] = {jobs = "Miner",img =  "./img/miner.png",img2 =  "./img/miner2.png",info = "Nepieciesama palīdzība, lai iegūtu un pārdotu minerālus no raktuves" },
    ...
    { 
        [1] = {jobs = "Electrician",img =  "./img/electrician.png",img2 =  "./img/electrician2.png",info = "Tādā modernā pilsētā kā Los Santos ir nepieciešami daudzi elektriķi, lai uzturētu infrastruktūru." },
    ...
    { 
        [1] = {jobs = "Builder",img =  "./img/builder.png",img2 =  "./img/builder2.png",info = "Mēs dzīvojam plašā pilsētā. Katru dienu tiek būvētas lielas ēkas. Palīdzi tās būvēt un nopelni naudu no tā." },
    ...
    { 
        [1] = {jobs = "Gardener",img =  "./img/gardener.png",img2 =  "./img/gardener2.png",info = "Golfa klubs maksā, lai tu uzturētu golfa laukumus nevainojamā stāvoklī. Tas ir godājams veids, kā nopelnīt naudu." },
    ...
    { 
        [1] = {jobs = "Sweeper",img =  "./img/sweeper.png",img2 =  "./img/sweeper2.png",info = "Ir daudz ielu, un ielas pašas sevi neiztīra. Pievēršies visu netīrumu tīrīšanai no ielām. Tas ir ļoti godājams darbs." },
    ...
    { 
        [1] = {jobs = "Cleaner",img =  "./img/cleaner.png",img2 =  "./img/cleaner2.png",info = "Tu tīri lielo biroju logus. Tu saņemsi labu samaksu, jo ļoti maz cilvēku vēlas veikt sadu smagu darbu." },
    ...
    { 
        [1] = {jobs = "Fruit Shop",img =  "./img/fruitshop.png",img2 =  "./img/fruitshop2.png",info = "Pilsētas augļveikals meklē cilvēkus, lai palīdzētu lasīt augļus no augļu kokiem. Tā nav sarežģīta darba, un samaksa ir laba." },
    ...
    { 
        [1] = {jobs = "Fisherman",img =  "./img/fisherman.png",img2 =  "./img/fisherman2.png",info = "Grupa patstāvīgu zvejnieku meklē kādu, kas palīdzētu noķert zivis tuvu klintīm. Tas ir grūtāks darbs nekā zveja ar laivu, bet tu noteikti ar to lieliski tiksi galā." },
    ...
    { 
        [1] = {jobs = "Plumber",img =  "./img/plumber.png",img2 =  "./img/plumber2.png",info = "Ūdensvada meistara darbs... Tu ne tikai neesi sauss, bet arī neslēpsi parastos defektus. Salabo dažas caurules pilsētas tunelos." },
    ...
    { 
        [1] = {jobs = "Butcher",img =  "./img/butcher.png",img2 =  "./img/butcher2.png",info = "Tu strādāsi pilsētas kaušanas namā, kur būs jāgriež daudz kaulu, cūku līķu un citu šaubīgas izcelsmes lietu." },
    ...
    { 
        [1] = {jobs = "Engineer",img =  "./img/engineer.png",img2 =  "./img/engineer2.png",info = "Nepieciešami kvalificēti inzēnieri, lai risinātu problēmas ar lidmasīnām, kas ierodas pilsētas lidostā. Tas ir labi apmaksāts darbs." },
    ...
    { 
        [1] = {jobs = "Junkyard",img =  "./img/junkyard.png",img2 =  "./img/junkyard2.png",info = "Vēl ir daudz metāllūžņu, ko jāsadrupina un jānodod pārdošanā vecajā atkritumu laukumā. Jauni krājumi ierodas katru dienu. Tas ir netīrs, bet godājams darbs." },
    ...
    { 
        [1] = {jobs = "Carpenter",img =  "./img/carpenter.png",img2 =  "./img/carpenter2.png",info = "Sawmillā ir nepieciešami galdnieki, lai strādātu ar neapstrādātu koksni. Viņi pat domā par mēbeļu izgatavošanu no apstrādātās koksnes - tas ir labs darbs!" },
    ...
    { 
        [1] = {jobs = "Harvest",img =  "./img/harvest.png",img2 =  "./img/harvest2.png",info = "Pilsētas vīna dārziem nepieciešami daudzi cilvēki, lai palīdzētu nolasīt visus vīnogas, kas nepieciešamas vīna ražošanai. Tavs darbs ir vienkāršs: nocērt vīnogu ķekarus un labi tos uzglabā turpmākai apstrādei." },
    ...
    { 
        [1] = {jobs = "Digger",img =  "./img/digger.png",img2 =  "./img/digger2.png",info = "Vējpārvadu montētājiem nepieciešams ekskavators, lai noņemtu dažus koku stumbrus no teritorijas, kur būs jāuzstāda vējpārdevēji. Tev būs nepieciešama liela spēka un laba lāpsta." },
    ...
    { 
        [1] = {jobs = "Stable",img =  "./img/stable.png",img2 =  "./img/stable2.png",info = "Lielai muižai pie pilsētas malām nepieciešams stallis, lai palidzētu ar stalliem. Darbs būs smags, bet samaksa būs pietiekami laba." },
    ...
    { 
        [1] = {jobs = "Delivery",img =  "./img/delivery.png",img2 =  "./img/delivery2.png",info = "Vietējais hamburgeru veikals meklē piegādātājus savām telpām. Tu piegādāsi ēdienu klientiem, kuri pasūta no mājām." },
    ...
    { 
        [1] = {jobs = "Warehouse",img =  "./img/warehouse.png",img2 =  "./img/warehouse2.png",info = "Mazajam lidostai ziemeļos nepieciešama papildus palīdzība, lai pārvietotu dažas kastes. Mazais noliktavas telpa ir pilna līdz malām, un tev būs jāpaņem kastes un jāieliek tās furgonā transportēšanai." },
...
--NEWS JOBS
    { 
        [1] = {jobs = "Chimney",img =  "./img/chimney.png",img2 =  "./img/chimney2.png",info = "Tev būs jāiztīra netīrumi no ēkas skursteņiem. Darbs ir augsts - uzmanies no vertigo!" },
    ...
    { 
        [1] = {jobs = "Asphalt",img =  "./img/asphalt.png",img2 =  "./img/asphalt2.png",info = "Ceļā ir daudz bedres. Kā darbinieks tev būs jāizlīdzina un jālabo ceļš, lai novērstu negadījumus." },
    ...
    { 
        [1] = {jobs = "Petrol Filler",img =  "./img/petrol.png",img2 =  "./img/petrol2.png",info = "Tev būs jāuzpilda degvielas tvertnes dažās degvielas uzpildes stacijās. Tas ir diezgan labs un labi apmaksāts darbs." },
    ...
    { 
        [1] = {jobs = "Trailer Clean",img =  "./img/trailer.png",img2 =  "./img/trailer2.png",info = "Tu saņem samaksu, lai tīritu piekabes pilsētas kravas automašīnu vadītājiem. Patiesībā tas ir diezgan labi apmaksāts darbs." },
    ...
    { 
        [1] = {jobs = "Oil Logistics",img =  "./img/oil.png",img2 =  "./img/oil2.png",info = "Tev jāizvāc naftas mucas no dažādām naftas ieguves stacijām. Tas ir svarīgs darbs." },
