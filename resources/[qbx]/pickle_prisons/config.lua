...
Config.ServeTimeOffline = true -- When set to true, players can serve their time offline, lowering the time by how long they were gone.
...
Config.Activities = {
    -- ["workout"] = {
    --     label = "Treniņš", -- Will have Start / Stop in front of interaction.
    --     sections = { -- Sections for this activity.
    --         ["lift"] = {
    --             label = "Svari celšana",
    --             rewards = { -- Rewards for completing the section.
    --                 {type = "xp", name = "spēks", amount = 1000},
    --             },
    ...
    -- },
    -- ["clean"] = {
    --     label = "Cietuma tīrīšana", -- Will have Start / Stop in front of interaction.
    --     sections = { -- Sections for this activity.
    --         ["sweep"] = {
    --             label = "Slaucīt grīdu",
    --             rewards = { -- Rewards for completing the section.
    --                 {type = "nauda", amount = 50},
    --             },
    --             process = function(data) -- Section function. 
    --                 local ped = PlayerPedId()
    --                 FreezeEntityPosition(ped, true)
    ...
    -- },
    -- ["kitchen"] = {
    --     label = "Virtuves darbs", -- Will have Start / Stop in front of interaction.
    --     sections = { -- Sections for this activity.
    --         ["stock"] = {
    --             label = "Savākt sastāvdaļas",
    ...
    --         },
    --         ["delivery"] = {
    --             label = "Piegādāt ēdienu",
    --             rewards = {-- Rewards for completing the section.
    --                 {type = "nauda", amount = 200},
    --                 {type = "xp", name = "ēdienu gatavošana", amount = 1000},  
    --             },
    --             process = function(data) -- Section function. 
    --                 local ped = PlayerPedId()
        ...
        activities = {
            {
                ...
                sections = {
                    {
                        name = "lift",
                        coords = vector3(1778.9808, 2490.7805, 45.8215),
                        heading = 208.1080,
                    },
                    {
                        name = "situp",
                        coords = vector3(1777.6227, 2493.6897, 45.8387),
                        heading = 30.8504,
                    },
                    {
                        name = "pushup",
                        coords = vector3(1775.9801, 2493.0325, 45.8392),
                        heading = 205.8405,
                    },
                    {
                        name = "pullup",
                        coords = vector3(1775.9714, 2497.2822, 45.8233),
                        heading = 31.7540,
                    },
                }
            },
            {
                name = "clean",
                model = {hash = `u_m_y_prisoner_01`},
                coords = vector3(1745.8707, 2478.0322, 45.8129),
                heading = 299.6434,
                randomSection = true, -- Chooses random section when true, or top-to-bottom when false.
                sections = {
                    {
                        name = "sweep",
                        coords = vector3(1749.3838, 2474.2778, 45.8120), -- Location of the cell.
                        heading = 300.7844, -- Direction to face the player upon spawn.
                    },
                    {
                        name = "sweep",
                        coords = vector3(1771.4032, 2486.4709, 45.8190), -- Location of the cell.
                        heading = 292.8735, -- Direction to face the player upon spawn.
                    },
                    {
                        name = "sweep",
                        coords = vector3(1763.4097, 2491.3164, 45.8198), -- Location of the cell.
                        heading = 216.2905, -- Direction to face the player upon spawn.
                    },
                    {
                        name = "sweep",
                        coords = vector3(1749.3572, 2484.6111, 50.4229), -- Location of the cell.
                        heading = 123.5068, -- Direction to face the player upon spawn.
                    },
                    {
                        name = "sweep",
                        coords = vector3(1773.5946, 2486.8628, 50.4243), -- Location of the cell.
                        heading = 297.8529, -- Direction to face the player upon spawn.
                    },
                    {
                        name = "sweep",
                        coords = vector3(1744.2684, 2482.2375, 45.8142), -- Location of the cell.
                        heading = 119.1865, -- Direction to face the player upon spawn.
                    },
                }
            },
            {
