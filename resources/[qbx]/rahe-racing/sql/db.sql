-- Running db.sql is required in order for the racing application to work.
-- Running tracks.sql is voluntary, only run that if you wish to get some pre-made tracks into the application.
