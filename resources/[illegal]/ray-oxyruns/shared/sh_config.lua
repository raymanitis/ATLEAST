...
Config.StartLocation = vector4(434.9552, -1907.0229, 25.9306, 217.2169) -- Start location for oxy run
Config.RunAmount = math.random(7, 10) -- How many drop-offs the player can make each run.
Config.StartOxyPayment = 400 -- How much you pay at the start to start the run
...
Config.LaunderItem = 'black_money'

Config.OxyChance = 50 -- %Chance to receive oxy
Config.OxyItem = 'oxy'

Config.RareLoot = 5 -- %Chance to receive a rare loot item
Config.RareLootItem = 'blueprint_de' -- Rare loot item
