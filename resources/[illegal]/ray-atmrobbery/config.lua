...
Config.Dispatch = "op-dispatch" -- cd_dispatch, linden_outlawalert, ps-disptach, core-dispatch, qs-dispatch
Config.SearchDuration = 6000 -- How long will the player search the pleace IN MS
Config.HackingDevice = "atm-robbery" -- Name for your hacking item
...
Config.Reward = math.random(2500, 3500) -- Cash Reward per bill.
Config.Cooldown = 10 -- Cooldwon in minutes.
Config.CopsNeeded = 0 -- Cops needed to start the robbery.