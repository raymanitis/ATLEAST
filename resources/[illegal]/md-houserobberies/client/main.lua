                ...
                options = {
                    {
                        ...
                        canInteract = function()
                            if Config.Houses[k]['spawned'] then return true end
                        end
                    },
                    {
                        name = 'makesmoke',
                    ...
                    },
                    {
                        ...
                        onSelect = function()
                            ...
                            TriggerServerEvent('md-houserobberies:server:closeHouse', k)
                        end,
                        canInteract = function()
                            if Config.Houses[k]['spawned'] and QBCore.Functions.GetPlayerData().job.type == 'leo' then return true end
                        end
                    },
                    {
                        ...
                        onSelect = function()
                            ...
                            if Config.Houses[k]['tier'] <= 4 then
                                ...
                                -- Replace the minigame with SN-Hacking export
                                ...
                                if success then
                                    ...
                                    Notify("Failed to lockpick the house!", "error")
                                end
                            elseif Config.Houses[k]['tier'] == 5 then
                                ...
                                exports['ps-ui']:VarHack(function(success)
                                    if success then
                                        ...
                                        Notify("It's Just Some Numbers In Order, It Isn't Hard", "error")
                                    end
                                end, 5, 8)
                ...
                options = {
                    {
                        ...
                        onSelect = function() SetEntityCoords(PlayerPedId(), Config.Houses[k].coords) end,
                    },
                },
                distance = 2.0
            })
                ...
                options = {
                    {
                        ...
                        icon = "fas fa-sign-in-alt",
                        label = "Leave Robbery House",
                        action = function() SetEntityCoords(PlayerPedId(), Config.Houses[k].coords) end,
                    },
                },
                distance = 2.0
            })
