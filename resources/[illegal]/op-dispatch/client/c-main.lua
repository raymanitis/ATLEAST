...
CreateThread(function()
    while true do
        ...
        if Config.ShootingAlerts and IsPedShooting(ped) then
            ...
            local isPolice = exports.qbx_core:HasGroup('police') -- Check for police job
            
            if not isPolice then
                -- Trigger alert if the player is NOT police
                ...
                if Cooldown == false then
                    TriggerServerEvent('Opto_dispatch:Server:SendAlert', 'police', title, text, coords, panic, id)
                    ShootingBlip()
