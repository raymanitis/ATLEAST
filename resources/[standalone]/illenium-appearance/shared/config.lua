...
Config.Stores = {
    ...
    {
        type = "clothing",
        coords = vector4(461.4868, -999.0070, 30.6895, 76.6364),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(463.8954, -999.6498, 30.9379),
            vector3(463.8970, -995.9341, 30.6895),
            vector3(458.6072, -995.5107, 30.6895),
            vector3(457.1299, -997.3010, 30.6895),
            vector3(457.6689, -999.7529, 30.6895)
        }
    }
}
...
Config.ClothingRooms = {
    -- {
    --     job = "police",
    --     coords = vector4(461.7029, -998.7272, 30.6895, 242.7774),
    --     size = vector3(4, 4, 4),
    --     rotation = 45,
    --     usePoly = true,
    --     points = {
